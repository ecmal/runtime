        ...
        Loader.prototype.define = function (module) {
            ...
            if (module.defined) {
                ...
                if (module.dependencies.length) {
                    var promises = module.dependencies.map(function (m) { return _this.define(m); });
...
(function (Reflect) {
    ...
    function decorate(decorators, target, key, desc) {
        decorators.push(Reflect.metadata('design:module', {
            ...
            deps: module.dependencies && module.dependencies.length
                ? module.dependencies.map(function (m) { return m.id; })
                : []
        }));
    ...
    function setCurrentModule(current) {
        module = current;
    }
    Reflect.setCurrentModule = setCurrentModule;
    ...
    var System = (function () {
        ...
        Object.defineProperty(System.prototype, "modules", {
            get: function () {
                var _this = this;
                var modules = {};
                Object.keys(this.loader.modules).forEach(function (k) {
                    modules[k] = _this.loader.modules[k].exports;
                });
                return modules;
            },
            enumerable: true,
